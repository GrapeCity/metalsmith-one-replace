...
module.exports = class Plugin {
  ...
  constructor(options) {
    this.consoleLog = typeof options.consoleLog ? options.consoleLog : false;
    this.enabled = typeof options.consoleLog ? options.enabled : true;
    this._actions = typeof options.actions
